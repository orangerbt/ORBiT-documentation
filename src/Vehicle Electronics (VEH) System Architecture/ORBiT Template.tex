...
The high speed sensor unit will use to contain sensors that have more than 100MB/s (ex: camera) It will have a special power line from the PAM and itself will have memory for buffing data.
...
\begin{table}[H]
	...
	\begin{tabu}{r || c | c | c }
		...
		A02 & Jinzhi Cai & change PAM unit describtion & 2019-7-3\\ \hline
	\end{tabu}
