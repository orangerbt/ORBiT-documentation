...
\begin{table}[H]
	...
	\begin{tabu}{r || c | c | c | c }
		...
		A04 & Gabriel Smolnycki & & \shortstack{Formatting and consistency\\with system architecture} & 2019-07-08\\ \hline
		A05 & Gabriel Smolnycki & & \shortstack{Easier camera and\\power supply requirements} & 2019-07-23
	\end{tabu}
