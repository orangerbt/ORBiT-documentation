...
\newpage
\chapter{Big Picture}
The whole system have different part. All the stations will connect via wire or wireless connection. All the station itself will have ability to process data and send it back to the Main Control Facility.
\newpage
